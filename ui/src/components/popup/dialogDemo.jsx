...
export function DialogDemo({ buttonTitle }) {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      ...
      if (file.size > 102400) {
        setErrors((prev) => ({
          ...prev,
          logo: "Image must be less than 100KB",
        }));
        return;
      }
  ...
  const handleSubmit = async () => {
    try {
      ...
      const submitData = { ...formData, role: { roleName: formData.roleName } };
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_URLAPI}/users/create`,
        submitData
      );
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 space-y-1">
              ...
              <p className="text-xs text-gray-500">
                Please choose a square image, less than 100Kb
              </p>
