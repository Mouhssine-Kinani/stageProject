...
function BaseDialog({ open, setOpen, title, children, onSubmit }) {
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[800px]">
        ...
        <form onSubmit={onSubmit}>
          {children}
          <DialogFooter>
            <Button className="bg-gray-100 text-black hover:bg-gray-200 px-6" type="button" onClick={() => setOpen(false)}>Cancel</Button>
...
export default function AddUserDialog() {
  ...
  return (
    <BaseDialog open={open} setOpen={setOpen} title="Add New User" onSubmit={handleSubmit}>
      <div className="flex flex-col md:flex-row gap-6 py-4">
        ...
        <div className="flex-1 space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="fullName" placeholder="John Doe" value={formData.fullName} onChange={handleChange} className={errors.fullName ? "border-red-500" : ""} />
              {errors.fullName && <p className="text-xs text-red-500">{errors.fullName}</p>}
            </div>

            <div className="space-y-2">
              <Label htmlFor="phone">Phone number</Label>
              <Input id="phone" placeholder="212 661651425" value={formData.phone} onChange={handleChange} className={errors.phone ? "border-red-500" : ""} />
        ...
        <div className="flex-1 space-y-6">
          <div className="space-y-2">
            ...
            <Input id="email" type="email" placeholder="john.doe@example.com" value={formData.email} onChange={handleChange} className={errors.email ? "border-red-500" : ""} />
          ...
          <div className="grid grid-cols-1 w-full">
            <div className="space-y-2">
              ...
              <Select onValueChange={(value) => handleSelectChange(value, "roleName")} value={formData.roleName}>
              ...
              {errors.roleName && <p className="text-xs text-red-500">{errors.roleName}</p>}
            </div>
          </div>
        </div>
      </div>
...
export function DataTable({columns}) {
  const {data, setCurrentPage, currentPage , totalPages} = useCrud("users")
