...
export default function AddUserDialog({ open, onOpenChange }) {
  ...
  const { validateFile, createItem } = useCrud("users");
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      if (result.success) {
        ...
        const event = new CustomEvent("userAdded", { detail: result.data });
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        ...
        <DialogContent className="sm:max-w-[800px]">
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <p className="text-xs text-gray-500">
                    Please choose a square image, less than 1MB
                  </p>
            ...
            <DialogFooter>
              <Button
                className="bg-gray-100 text-black hover:bg-gray-200 px-6"
